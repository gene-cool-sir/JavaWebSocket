        ...
        <div class="am-tabs am-margin" data-am-tabs>
            ...
            <div class="am-tabs-bd">
                    ...
                    <form class="am-form am-form-horizontal" id="information-form" action="${ctx}/update" method="post" data-am-validator>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-10">
                                <input type="text" id="username" name="username" value="${currentUser.username}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-10">
                                <input type="text" id="nickname" name="nickname" value="${currentUser.nickname}" required placeholder="这里输入你的昵称...">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-10">
                                <input type="number" id="age" name="age" min="1" max="100" value="${currentUser.age}" placeholder="这里输入你的年龄...">
                            </div>
                        </div>
                        <div class="am-form-group">
                            ...
                            <script>
                                $("#profile").val("${currentUser.profile}");
                            </script>
                        </div>
                        <div class="am-form-group">
                ...
                <div class="am-tab-panel am-fade" id="tab2">
                    <form class="am-form am-form-horizontal" action="${ctx}/upload" enctype="multipart/form-data" method="post" onsubmit="return checkFileType();" style="text-align: center;">
                        <div style="text-align: center;margin-bottom: 10px">
                            <img class="am-circle" src="${ctx}/head" width="140" height="140" alt="Amayadream"/>
                        </div>
